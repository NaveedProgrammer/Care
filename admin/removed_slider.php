<?php
    ...
    $db->select('slider',"*","`s_status`='nonactive'"); 
       
 ?>

<a href="all_slider.php" class="btn btn-primary" style="margin-left:3%">Active Slides</a>
...
?>
    <tr>
      ...
      <td>
          <a href="edit_slider.php?id=<?php echo $row[0];?>"><i class="fas fa-edit fa-lg"></i></a>
