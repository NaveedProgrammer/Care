...
if (isset($_POST['BtnAdd'])) {
  ...
  $db->insert('doctor_tbl', ['DoctorName' => $name, 'DoctorEmail' => $email, 'DoctorContact' => $number, 'DoctorAddress' => $address, 'DoctorQualification' => $qualification, 'DoctorPassword' => $password, 'DoctorSpecialization' => $specialization,'DoctorCity' => $city, 'DoctorImage' => $image]);
